using CrmApp.Application.TodoItems.Commands.CreateTodoItem;
using CrmApp.Application.TodoItems.Commands.UpdateTodoItem;
using CrmApp.Application.TodoItems.Commands.UpdateTodoItemDetail;
using CrmApp.Application.TodoLists.Commands.CreateTodoList;
using CrmApp.Domain.Entities;
using CrmApp.Domain.Enums;

namespace CrmApp.Application.FunctionalTests.TodoItems.Commands;
